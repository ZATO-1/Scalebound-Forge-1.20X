...
public interface Bucketable {
    ...
    static <T extends LivingEntity & net.minecraft.world.entity.animal.Bucketable> Optional<InteractionResult> bucketMobPickup(Player pPlayer, InteractionHand pHand, T pEntity) {
